...
Программа записывает данные базу данных PostgreSQL следующим образом (редактируемый формат здесь [редактируемый файл](DB%20illustrarion/DataBase%20TG.drawio).
...
The program writes data to the PostgreSQL database as follows (editable format available here: [edible file](DB%20illustrarion/DataBase%20TG.drawio).

![Database](DB%20illustrarion/Database.png)
