...
Программа записывает данные базу данных PostgreSQL следующим образом (редактируемый формат здесь [файл](DB%20illustrarion/DataBase%20TG.drawio)).
...
The program writes data to the PostgreSQL database as follows (editable format available here: [file](DB%20illustrarion/DataBase%20TG.drawio)).
